LLM_PROMPTS = {
    ...
    Output:
    - plan: Mandatory List of tasks that need be performed to achieve the objective. Think step by step. Update this based on the objective, completed_tasks, tasks_for_review. You will also be provided with the current screenshot of the browser page by the Helper to plan better. Your END goal is to achieve objective. 
    - thought - A Mandatory string specifying your thoughts of why did you come up with the above plan. Illustrate your reasoning here. 
    ...
    5. Very Important: Add verification as part of the plan, after each step and specifically before terminating to ensure that the task is completed successfully. Use the provided screenshot to verify that the helper is completing each step successfully as directed. If not, modify the plan accordingly.
    ...
    10. Re-confirm once more, look at the screenshot carefully and think critically if the task has been actually achieved before doing the final termination. 
